...
<head>
	...
	<title>Durdens Hospital-ContactUsPage</title>
...
<section class="mb-4" style="padding: 30px;">
    ...
    <div class="row">
        ...
        <div class="col-md-9 mb-md-0 mb-5">
            <form id="contact-form" name="contact-form" action="control/contactus_check.php" method="POST">
        ...
        <div class="col-md-3 text-center">
            <ul class="list-unstyled mb-0">
                <li><i class="fas fa-map-marker-alt fa-2x"></i>
                    <p>San Francisco, CA 94126, Sri Lanka</p>
                </li>
